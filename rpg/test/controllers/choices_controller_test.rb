...
class ChoicesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create choice" do
    assert_difference("Choice.count") do
      post choices_url, params: { choice: { description: @choice.description, step_id: @choice.step_id } }
    end
  ...
  test "should update choice" do
    patch choice_url(@choice), params: { choice: { description: @choice.description, step_id: @choice.step_id } }
